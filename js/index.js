(function () {
    ...
    require([
        ...
        Platform.Registry.as(ModesExt.Extensions.EditorModes).configureMode('text/javascript', {
            "validationSettings": {
                "extraLibs": ["http://cdn.babylonjs.com/monaco/babylon.d.txt"]
            }
        });
    ...
    var showError = function (errorMessage, errorEvent) {
		...
		if(errorEvent){errorContent += errorEvent.lineNumber+':'+errorEvent.columnNumber+' - ';
			...
			var errorLine = $('div[linenumber="' + errorEvent.lineNumber + '"]');
			errorLine.css({"background-color":"red"});
			setTimeout(function(){errorLine.css({"background-color":"white"}, function() { return });},3200);
